...
//    String auth = "Basic " + Base64.getEncoder().encodeToString("admin:12345".getBytes());
    ...
    static Response loginResponse = new LoginAPI(adminUsername, adminPassword).loginUser(adminUsername, adminPassword);
    ...
    public void CreateProject(String key, String name, String description) {
        ...
        requestBody.put("projectTypeKey", "software"); // type
        requestBody.put("lead", "charlie");
    ...
    public void createEpicIssue(String summary, String issueDescription){
        ...
        issueType.put("name", "Task"); // issue type "epic" doesn't work
    ...
    public void updateProject(){
        ...
        requestBody.put("projectTypeKey", "software"); // change project type
